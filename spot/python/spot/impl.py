...
class to_parity_options(object):
    ...
    force_degen = property(_impl.to_parity_options_force_degen_get, _impl.to_parity_options_force_degen_set)
...
class zielonka_tree(object):
    ...
    def __init__(self, cond: "acc_cond"):
        _impl.zielonka_tree_swiginit(self, _impl.new_zielonka_tree(cond))
